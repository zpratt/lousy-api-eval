...
> **Note:** The canonical source is `scripts/spectral-report.mjs` in the repo root. The embedded copy below is for reference only — always defer to the actual file.
